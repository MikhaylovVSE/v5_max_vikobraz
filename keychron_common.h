...
enum {
    ...
    #define BT_HST1     KC_TRNS
    #define BT_HST2     KC_TRNS
    #define BT_HST3     KC_TRNS
    #define P2P4G       KC_TRNS
    #define BAT_LVL     KC_TRNS
#endif
#ifndef ANANLOG_MATRIX
    #define PROF1 KC_TRNS
    #define PROF2 KC_TRNS
    #define PROF3 KC_TRNS
#endif
